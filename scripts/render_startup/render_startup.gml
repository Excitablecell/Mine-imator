...
// DOF
globalvar render_dof_blades, render_dof_rotation, render_dof_ration, render_dof_samples, render_dof_weight_samples, render_dof_sample_amount, render_dof_quality;
render_dof_blades = -1
